...
$plugin = plugin::byId('jeebike');
sendVarToJS('eqType', $plugin->getId());
$eqLogics = eqLogic::byType($plugin->getId());
$jeebike = new jeebike();
$allcontracts = $jeebike->getAllContracts();
//$allstations = $jeebike->getAllStations();
?>
...
?>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        ...
        <legend><i class="fa fa-table"></i> {{Mes stations}}</legend>
        <div class="eqLogicThumbnailContainer">
<?php
foreach ($eqLogics as $eqLogic) {
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de la station}}"/>
                        </div>
                    </div>
                    <div class="form-group">
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select id="sel_contract" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="contract_name">
<?php
foreach ($allcontracts as $contract) {
    echo '<option value="'.$contract->name.'">'.$contract->country_code . '-' . $contract->name . '-' . $contract->commercial_name.'</option>'."\n";
}
?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select id="sel_number" class="eqLogicAttr form-control">
                                <option value="">--Numéro Station--</option>';
<?php
//            foreach ($allstations as $station) {
//                echo '<option value="'.$station->number.'">' . $station->name . '</option>';
//            }
?>
                            </select>
                        </div>
...
$('#sel_contract').change(function(){
    ...
    $contracts.on('change', function() {
        ...
        if(val != '') {
            ...
            $.ajax({
                url: 'plugins/jeebike/core/ajax/jeebike.ajax.php',
                data: 'id_contract='+ val, // on envoie $_POST['id_contract']
                dataType: 'json',
                success: function(json) {
...
<?php
include_file('desktop', 'jeebike', 'js', 'jeebike');
